...
namespace fractal {
	namespace fscene {
		...
		void MeshComponent::draw() const {
			...
			m_material->loadSpot(fmath::Vector3(0.7f, 0.2f, 2.0f), camera->getParent()->getComponent<TransformComponent>()->getPosition().FRONT, fmath::Vector3(0.0f, 0.0f, 0.0f), fmath::Vector3(1.0f, 1.0f, 1.0f), fmath::Vector3(1.0f, 1.0f, 1.0f), 1.0f, 0.09f, 0.032f, cos(toRadians(12.5f)), cos(toRadians(15.0f)));
