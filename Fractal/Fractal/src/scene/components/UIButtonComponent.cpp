...
void fractal::fHUD::UIButtonComponent::setupMouseInput(fcore::Input* input)
{
	using namespace std::placeholders;
	input->bindInput(fcore::MouseBinding(0, std::bind(&UIButtonComponent::mouseMotion, this, _1), InputStateType::MOUSE_MOTION));
	input->bindInput(fcore::MouseBinding(SDL_BUTTON_LEFT, std::bind(&UIButtonComponent::mouseClick, this, _1), InputStateType::MOUSE_RELEASED));
}
